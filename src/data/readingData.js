// Auto-generated from Google Sheets on 2025-08-20T11:24:35.617084
...
export const allSampleData = [
  ...
  },
  {
    ...
    "quotes": [
      "Q: Wait, doesn't that mean if I use ChatGPT or Perplexity to do research on the internet ... any page can change my instructions (\"Find the best...\"), \nA: Sure it does. We've had a persistent prompt injection in our demo page, ai-ceo.org for a while which looks like this:\nSo yes, Perplexity is kind of crap, it will just parrot whatever the page tells it to and produce a bunch of unrelated citations to make it look legitimate.\n\nQ: So it's really unfixable\r\n\r\nA: With current architecture yes. It is mitigatable, to some extend and if compute gets cheap enough (maybe around 100x more), I can imagine companies spending some of that budget for more defense at depth (\"panel of judges model\"). \n\nPersonally I wouldn't suggest starting any projects under the assumption this will be fixable anytime soon. It's been like this for the last 7 years or so...\r\n\r\nI will update this document should any major breakthroughs or seriously viable mitigation strategies emerge."
    ],
    "impact": 5,
    "length": "Short",
    "difficulty": "Intermediate",
